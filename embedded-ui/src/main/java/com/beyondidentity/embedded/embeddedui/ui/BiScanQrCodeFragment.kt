...
class BiScanQrCodeFragment : BiBaseBottomSheetDialogFragment() {
    ...
    private fun setupViews(view: View) {
        ...
        useDigitCode.setOnClickListener {
            BiEnterCodeFragment
                .newInstance()
                .show(parentFragmentManager, BiEnterCodeFragment.TAG)
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment [BiScanQrCodeFragment].
         */
        @JvmStatic
        fun newInstance() = BiScanQrCodeFragment()
    }
}
