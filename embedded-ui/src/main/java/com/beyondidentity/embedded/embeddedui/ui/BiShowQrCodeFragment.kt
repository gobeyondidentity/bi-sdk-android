...
class BiShowQrCodeFragment : BiBaseBottomSheetDialogFragment() {
    ...
    private fun setupViews(view: View) {
        ...
        showQrDesc.text = getString(R.string.show_qr_desc, EmbeddedSdk.config.appDisplayName)
    }
    ...
    companion object {
         ...
         **/
        @JvmStatic
        fun newInstance(credHandle: String) = BiShowQrCodeFragment().apply {
