 ...
 */
data class AuthenticationContext(val authUrl: String, val application: Application, val origin: Origin) {
    ...
    companion object {
        fun from(authenticateResponse: BiAuthenticationContext) = AuthenticationContext(
